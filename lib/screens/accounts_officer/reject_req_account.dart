...
class RejectedRequisitionsScreen extends StatefulWidget {
  const RejectedRequisitionsScreen({Key? key}) : super(key: key);

  @override
  State<RejectedRequisitionsScreen> createState() => _RejectedRequisitionsScreenState();
}

class _RejectedRequisitionsScreenState extends State<RejectedRequisitionsScreen> {
  int _currentIndex = 3;
  String _search = '';

  final List<Map<String, String>> requisitions = [
    {'name': 'Event 2', 'date': '18/05/25'},
    {'name': 'Event 5', 'date': '22/05/25'},
    {'name': 'Event 8', 'date': '25/05/25'},
    {'name': 'Event 12', 'date': '29/05/25'},
  ];
